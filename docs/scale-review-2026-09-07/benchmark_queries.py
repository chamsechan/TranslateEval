...
Usage (from repository root):
  .venv/bin/python docs/scale-review-2026-09-07/benchmark_queries.py seed /tmp/te-scale-24000.db --samples 24000
  .venv/bin/python docs/scale-review-2026-09-07/benchmark_queries.py run /tmp/te-scale-24000.db
  .venv/bin/python docs/scale-review-2026-09-07/benchmark_queries.py history /tmp/te-scale-24000.db --jobs 6
  .venv/bin/python docs/scale-review-2026-09-07/benchmark_queries.py run /tmp/te-scale-24000.db --cases results_one results_mean_one results_default
...
CASES = ["datasets", "versions", "samples_first", "samples_deep", "summary", "items_first", "items_deep", "items_score", "items_language", "items_exact", "results_one", "results_default", "results_mean_one", "compare_two"]
